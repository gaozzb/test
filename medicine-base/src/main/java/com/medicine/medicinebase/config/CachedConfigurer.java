...
public interface CachedConfigurer {
    ...
    public enum CacheManagerEnum {
        ...
        public static class $ {
            public final static String GUAVACACHE = "guavaCacheManager";
            public final static String REDISCACHE = "redisCacheManager";
        }
    }
    ...
    public enum ExpireTimeEnum {
        ...
        ExpireTimeEnum(int ttl, String desc) {
            this.ttl = ttl;
            this.desc = desc;
        }
